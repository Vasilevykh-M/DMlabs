...
async def parse_twitch():
    async with async_playwright() as p:
        ...
        try:
            await page.wait_for_selector("div.ScTower-sc-1sjzzes-0.fwymPs.tw-tower", timeout=20000)
            top_games_locator = page.locator("div.ScTower-sc-1sjzzes-0.fwymPs.tw-tower")
            top_games_locator = top_games_locator.locator("div.OBUFH.ScTransitionBase-sc-hx4quq-0.tw-transition")
